...
class IE:
    ...
    def FLH(self, enhancement):
        ...
        return utils.LUT_image(LUT)
    # Source of the following cellcode is: Sandimanna 
    ...
    def interpolate(self, subBin,LU,RU,LB,RB,subX,subY):
    ...
    def clahe(self, img, clipLimit, nrBins=128,nrX=0,nrY=0):
        '''img - Input image
        ...
        for i in range(nrX+1):
            ...
            for j in range(nrY+1):
                ...
                subImage = self.interpolate(subBin,UL,UR,BL,BR,subX,subY)
